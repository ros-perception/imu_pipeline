...
namespace imu_transformer
{
  ...
  : Node("imu_transformer", options){
    ...
    imu_filter_ = std::make_shared<ImuFilter>(imu_sub_, *tf2_buffer_, target_frame_, 10, *this, buffer_timeout);
    ...
    mag_filter_ = std::make_shared<MagFilter>(mag_sub_, *tf2_buffer_, target_frame_, 10, *this, buffer_timeout);
